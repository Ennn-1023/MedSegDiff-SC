...
# 對應訓練腳本：train_ph2_lora_attn_emb_r32.sh

# 設定模型路徑（請根據實際訓練結果修改）
MODEL_PATH="./results/ph2_lora_attn_emb_r32_T50_DPM/model001000.pt"
DATA_DIR="./data/PH2/Test"
OUT_DIR="./results/predictions_PH2_lora_attn_emb_r32_T50_DPM"
